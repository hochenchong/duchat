...
public class PageBaseResp<T> {
    ...
    public static <T> PageBaseResp<T> init(int pageNo, int pageSize, Long totalRecords, Boolean isLast, List<T> list) {
        return new PageBaseResp<>(pageNo, pageSize, totalRecords, isLast, list);
    }

    public static <T> PageBaseResp<T> init(int pageNo, int pageSize, Long totalRecords, List<T> list) {
    ...
    public static <T> PageBaseResp<T> init(PageBaseResp resp, List<T> list) {
        return init(resp.getPageNo(), resp.getPageSize(), resp.getTotalRecords(), resp.isLast(), list);
    }
